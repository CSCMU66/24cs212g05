...
#     order_id = db.Column(db.Integer, db.ForeignKey('orders.order_id'), nullable=False)  # รหัสคำสั่งซื้อที่ชำระ (Foreign Key)
...
#     def __init__(self, order_id, payment_method, payment_time, amount):
#         self.order_id = order_id
#         self.payment_method = payment_method
#         self.payment_time = payment_time
#         self.amount = amount

#     def update(self, payment_method, payment_time, amount):
#         self.payment_method = payment_method
#         self.payment_time = payment_time
#         self.amount = amount
